      ...
      <div class="hero-banner-sm-content">
        ...
        <nav aria-label="breadcrumb" class="banner-breadcrumb" style="color:black;">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" style="color:black;">Register</li>
          </ol>
        </nav>
      </div>
    </div>
...
<div class="container text-center">
					...
					<center>
						<div class="form-group">
							<input placeholder="Full Name" name="name" type="text" required=""class="form-control">
						</div>
						<div class="form-group">
							<input placeholder="Email" name="email" type="email" required=""class="form-control">
						</div>
						<div class="form-group">
							<input  placeholder="Username" name="uname" type="text" required=""class="form-control">
						</div>
						<div class="form-group">
